...
//        EnumStudent e4 = new EnumStudent("hong4","firstgrade");

//        Enum 클래스를 활용한 classGrade 세팅
//        Enum 클래스의 변수값을 세팅하도록 강제함으로서, 특정변수값의 종류를 제한
        EnumStudent e5 = new EnumStudent("hong1", ClassGrade.FIRST_GRADE);
//        EnumStudent e6 = new EnumStudent("hong2", SECOND_GRADE); // 타입불일치

        System.out.println(e5.getClassGrade());
        System.out.println(e5.getClassGrade().getClass());
//        enum값 내부에는 저장된순서대로 0부터 index값이 내부적으로 할당
        System.out.println(e5.getClassGrade().ordinal());
