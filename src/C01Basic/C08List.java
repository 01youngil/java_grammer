...
//        ArrayList<String> myList2 = new ArrayList<>(); // 후문 타입 생략가능
//
////        가장 일반적인 List 선언방식
...
//        myList.remove(0);
//        System.out.println(myList); // [20, 30]
//        myList.remove(Integer.valueOf(20));
//        System.out.println(myList); // [30]
//
////        set(index, value) : 인덱스 위치 자리에 value값 setting(변경)
//        myList.set(0,50);
//        System.out.println(myList); // [50]
//
////        clear : 요소 전체 삭제
...
//        System.out.println(myList.indexOf(20)); // 1
